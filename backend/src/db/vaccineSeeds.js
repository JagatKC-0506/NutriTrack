...
const vaccines = [
  ...
  {
    name: 'Meningococcal Vaccine (Pediatric)',
    emoji: '💉',
  ...
  },
  {
    name: 'RSV',
    emoji: '💉',
    description: 'Recommended between 32-36 weeks gestation. Protects newborn against Respiratory Syncytial Virus (RSV), a leading cause of infant hospitalization. Passes protective antibodies to baby.',
    total_doses: 1,
    recipient_type: 'mother',
    recommended: true,
  },
